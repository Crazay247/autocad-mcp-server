"""Abstract base class for AutoCAD backends + CommandResult envelope (ACP-aware: GetACP 936->gbk else cp1252)."""
...
class BackendCapabilities:
    ...
    # Compatibility alias: plan test expects can_create
    @property
    def can_create(self) -> bool:
        return self.can_create_entities

    @can_create.setter
    def can_create(self, value: bool) -> None:
        self.can_create_entities = value
